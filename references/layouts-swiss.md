...
本主题的 golden source 是 `assets/template-swiss.html` 自身以及 `references/swiss-layout-lock.md` 登记的 22 个版式。
...
1. 同时打开两份页面:`template-swiss.html` 自身（作为 golden source）和正在修改的测试 PPT。
